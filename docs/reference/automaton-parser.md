...
Равнозначные захваты получают одну представительную историю, как в публичном
API исходного парсера; это не API перечисления всех синтаксических выводов.
...
компилятор AST и те же управляющие переходы, сохраняя собственные аннотации
параметров и правила метаданных.
