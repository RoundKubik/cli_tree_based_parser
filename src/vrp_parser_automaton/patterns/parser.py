...
class PatternParser:
    ...
    def _parse_group(self, opening: Token) -> Group:
        ...
        closing_kind = TokenKind.RIGHT_BRACKET if optional else TokenKind.RIGHT_BRACE
        ...
        if self._current.kind is TokenKind.STAR:
            ...
            mode = GroupMode.OPTIONAL_SET if optional else GroupMode.REQUIRED_SET
            end = suffix.span.end
        else:
            mode = GroupMode.OPTIONAL_ONE if optional else GroupMode.REQUIRED_ONE
