...
from vrp_parser.patterns import Literal, Parameter
...
class LiteralExpressionMatcher:
...
class ParameterExpressionMatcher:
    ...
    def match(
        ...
        *,
        ...
        if result.status is ParameterStatus.VALID:
            ...
            parameters = state.parameters
            rejected = state.rejected + (
                RejectedParameter(declaration, token, result),
            )
