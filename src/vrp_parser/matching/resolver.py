"""Resolve full graph candidates without hiding real ambiguity."""
...
from vrp_parser.results import MatchStatus, ParseError, PatternMatch
...
class MatchResolver:
    ...
    def __init__(
        ...
        self._validation_errors = (
            validation_errors or ValidationErrorFactory()
        )
    ...
    def _applicable_frontier(
        ...
        applicable = tuple(
            ...
            and all(
                rejection.applicable for rejection in item.state.rejected
            )
        )
